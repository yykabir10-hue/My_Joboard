...
# Backend engineer roles in Munich, last 14 days
bun run .agents/skills/linkedin-search/cli/src/cli.ts search -q "backend engineer" -l "Munich, Bavaria, Germany" --jobage 14 --format table
